// Agent B's fixed shot list (phase 2): people, creatures, creation and the ruin fight.
// Usage: node tests/p2-b-shots.mjs <port> <round> [shot,shot,...]
// Shoots a FROZEN build (tests/p2-build-B.sh, then vite preview). Honours comms/BROWSER.lock.
...
const ME = 'agent B (tests/p2-b-shots.mjs)';
...
const shot = async (name) => {
  const out = `test-output/p2-B-${round}-${name}.png`;
