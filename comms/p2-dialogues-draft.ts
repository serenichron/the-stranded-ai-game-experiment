...
export const apprentice: Dialogue = {
  ...
  readFull: {
    text: 'He is afraid. It is not the ded-waka. He keeps glancing at the north road, where nobody is. He hides it well, and he is not hiding it from you.',
...
export const foreman: Dialogue = {
  ...
  asleep: {
    speaker: 'foreman',
    text: 'Asleep. Not dead. Well. Asleep is quiet. We can work around quiet.',
...
export const scav: Dialogue = {
  ...
  keep: {
    speaker: 'scav',
    text: 'Good. Then you saw bolts. Only bolts. We will get on.',
    do: (c) => {
      c.set('pellTrust');
  ...
  threat: {
    speaker: 'scav',
    text: 'Then tell. I will be gone before your feet are dusty. Starve the thing and you still get your crystal. I pay debts, even to talkers.',
    do: (c) => {
...
export const signRings: Dialogue = {
  ...
  ringsMiss: {
    text: 'Three rings, drawn over and over, with a scratch through one. Which one? The lines blur. You will have to try the sockets and listen.',
    end: true,
  },
};
...
export const archive: Dialogue = {
  ...
  r5: {
    ...
    text: (c) =>
      isk(c)
        ? 'Something below is still awake. [For a moment you know this voice. Not the words. The voice. Then it is gone, and you do not know why your hands are shaking.]'
        : seh(c)
          ? 'Something below is still awake. [Under the voice, the ground hums. Not one hum. Many, very far down, like a crowd behind a wall.]'
...
export const tent: Dialogue = {
  ...
  t4: {
    text: '*...not the ded-waka. They came for the plate, not for me... tell them the stair... do not let them take...* The rest is ash.',
    do: async (c) => {
      c.give('note');
...
export const telFirst: Dialogue = {
  ...
  isk: {
    text: 'Then its head turns. Not towards a sound. Towards you. You have not made a sound.',
    next: 'end',
  },
  end: {
